    ...
    return (
      <div className="header__socials">
        <a
          ...
          target="_blank"
        >
          <BsLinkedin size={20} title="Icono de Linkedin" />
        </a>
        <a href="https://github.com/JajoScript" target="_blank">
          <BsGithub size={20} title="Icono de GitHub" />
        </a>
        <a
          href="https://www.instagram.com/jajoscript/?hl=es-la"
          target="_blank"
        >
          <BsInstagram size={20} title="Icono de Instagram" />
        </a>
        <a href="https://www.behance.net/javieralmarza" target="_blank">
          <BsBehance size={20} title="Icono de Behance" />
        </a>
      </div>
    );
  }
